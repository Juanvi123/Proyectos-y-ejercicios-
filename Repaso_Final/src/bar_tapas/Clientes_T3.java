 ...
 * @author juanv
 */
public class Clientes_T3 extends Thread {
      //CONSTANTES
    private static final int TIEMPO_MIN_BEBIDAS = 50;
    private static final int TIEMPO_MAX_BEBIDAS = 250;
    private static final int TIEMPO_MIN_TAPAS = 100;
    private static final int TIEMPO_MAX_TAPAS = 300;
    ...
    //CONSTRUCTOR
    public Clientes_T3(RC_Barra barra) {
        this.barra = barra;
