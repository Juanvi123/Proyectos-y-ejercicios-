...
acaba.
Versión 2
El reponedor coloca los artículos en la estantería mientras los clientes entran en el supermercado y cogen
artículos de la estantería .
La cajera transcurrido un tiempo ( 20 segundos) cierra el local echando al reponedor y a los clientes que
no hayan acabado la compra ( interrumpe a todos los hilos ) .
 */
...
public class Main_Supermercado_v1 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(TIEMPO_CAJERA_CIERRA);
